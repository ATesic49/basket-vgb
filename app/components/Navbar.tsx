...
function Navbar() {
    ...
    return (
        <>
            ...
            <div className='z-[49] fixed w-full flex justify-between items-center border-b backdrop-blur-xl px-4 py-4 '>
                <Link className='text-gray-100 italic font-bold' href='/'>Vbg Fanstasy</Link>
            ...
            <AnimatePresence>
                {isOpen ?
                    <>
                        <motion.div
                            className='fixed top-0 left-0 right-0 bottom-0 bg-gray-800 z-40 bg-opacity-50 backdrop-blur-sm' exit={{ opacity: 0 }}
                            animate={{ opacity: 1 }} onClick={() => setIsOpen(!isOpen)}></motion.div>
                        ...
                        <motion.div
                            ...
                            className='fixed gap-2 px-8 backdrop-blur-xl bg-gray-800 bg-opacity-75 top-0 bottom-0 z-50 pt-24   right-0 flex flex-col  '>
                            ...
                            >
                                ...
                                <p className='text'>Leaderboards</p>
