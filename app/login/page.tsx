        ...
        <div className='flex flex-col justify-center  items-center gap-8 max-h-screen  h-svh'>
            ...
            <div className='pt-8 p-4 bg-gray-100 bg-opacity-50  rounded-md flex flex-col gap-4 items-center justify-center'>
                ...
                <div className='flex justify-center items-center w-full relative'>
                    <button className=' p-2  rounded-md py-1 px-2  font-bold text-gray-100 w-fit bg-gradient-to-t from-orange-500 shadow-sm shadow-orange-600 focus:scale-95 duration-200   to-orange-400'>Uloguj se.</button>
                </div>
            </div>
